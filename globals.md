...
The **GLOBALS** section of the project definition file contains definitions of [paramters](<https://github.com/HASE-Group/Documents/blob/main/parameters.md>) that are accessible to all of the entities in the project.
